...
This outlines how to propose a change to karel. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("mpru/karel", fork = TRUE)`.
...
Please note that the karel project is released with a [Contributor Code
of Conduct](https://docs.ropensci.org/karel/CODE_OF_CONDUCT.md). By
